...
public class MainActivity extends ActivityBase implements EventListener{
	...
	private void initTab(){
		...
		fragments = new Fragment[] {recentFragment, contactFragment, settingFragment,findFragment };
		// 添加显示第一个fragment
//		FragmentManager mFragmentManager=getSupportFragmentManager();
//		FragmentTransaction mFragmentTransaction=mFragmentManager.beginTransaction();
//		mFragmentTransaction.add(R.id.fragment_container,recentFragment);
//		mFragmentTransaction.add(R.id.fragment_container,contactFragment);
//		mFragmentTransaction.add(R.id.fragment_container,settingFragment);
//		mFragmentTransaction.add(R.id.fragment_container,findFragment);
//		mFragmentTransaction.hide(contactFragment);
//		mFragmentTransaction.hide(settingFragment);
//		mFragmentTransaction.hide(findFragment);
